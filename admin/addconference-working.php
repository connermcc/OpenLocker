...
$url = 'http://www.espn.com/mens-college-basketball/conferences/standings/_/id/21/year/2016';
...
for ($h = 2; $h < count($data); ++$h) {
	...
	$sql = "INSERT INTO Schools (ID, Name, ESPNID) VALUES ('$schoolID', '$schoolname', '$espnID') ";
	mysqli_query($db, $sql);
